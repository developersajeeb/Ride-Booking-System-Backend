...
const registerDriver = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield driver_service_1.DriverServices.createDriver(req.body);
...
const getTotalEarningsRideHistory = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const driver = req.user;
    const driverId = driver.userId;
    const result = yield driver_service_1.DriverServices.getTotalEarningsRide(driverId);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
